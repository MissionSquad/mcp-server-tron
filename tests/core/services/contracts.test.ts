...
import { getConfiguredPrivateKey, getConfiguredWallet } from "../../../src/core/services/wallet";
...
const SIMPLE_STORAGE_BYTECODE = "";

describe("Contract Services Integration (Nile)", () => {
    // Only run if private key is provided
    const hasPrivateKey = !!process.env.TRON_PRIVATE_KEY || !!process.env.TRON_MNEMONIC;

    it.runIf(hasPrivateKey)("should deploy a simple storage contract", async () => {
